...
final class CallDetailsFooterViewHolder extends RecyclerView.ViewHolder implements OnClickListener {
  ...
  private final CallDetailDeletionListener callDetailDeletionListener;
  ...
  CallDetailsFooterViewHolder(View view, ReportCallIdListener reportCallIdListener,
                              CallDetailDeletionListener callDetailDeletionListener) {
    super(view);
  ...
  public void onClick(View view) {
    ...
    if (view == copy) {
      ...
      callDetailDeletionListener.callDetailDelete();
    } else {
  ...
  /** Listener for deleting Call log */
  interface CallDetailDeletionListener {

    /** Delete Call Detail */
    void callDetailDelete();
  }
}

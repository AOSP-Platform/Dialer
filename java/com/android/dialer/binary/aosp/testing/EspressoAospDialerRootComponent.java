...
import com.android.dialer.common.concurrent.testing.EspressoDialerExecutorModule;
...
/** Root component for espresso tests for the AOSP Dialer application. */
@Singleton
@Component(
  modules = {
    CallLogModule.class,
    ContextModule.class,
    EspressoDialerExecutorModule.class,
...
public interface EspressoAospDialerRootComponent extends BaseDialerRootComponent {}

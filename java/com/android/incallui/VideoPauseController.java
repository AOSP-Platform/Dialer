...
class VideoPauseController implements InCallStateListener, IncomingCallListener,
  ...
  private void onResume(boolean isInCall) {
    LogUtil.i("VideoPauseController.onResume", " onResume isInBackground " + isInBackground);
  ...
  private void onPause(boolean isInCall) {
    LogUtil.i("VideoPauseController.onPause", " onPause isInBackground " + isInBackground);

...
public class VideoChargesAlertDialogFragment extends DialogFragment {
  ...
  /**
   * Configuration whether to show an alert dialog for video charges.
   */
  private static final String CONFIG_VIDEO_CHARGES_ALERT_ENABLED = "video_charges_alert_enabled";
  ...
  public static boolean shouldShow(@NonNull Context context) {
    if (!ConfigProviderBindings.get(context).getBoolean(CONFIG_VIDEO_CHARGES_ALERT_ENABLED,
        false)) {
      return false;
    }
    ...
    if (preferences.getBoolean(KEY_DONOT_SHOW_VIDEO_CHARGES_ALERT, false)) {
        LogUtil.i(
   ...
   */
  public interface VideoChargesAlertCallback {
    /**
  ...
  public static VideoChargesAlertDialogFragment newInstance(
      @NonNull String callId, @NonNull VideoChargesAlertCallback callback) {
   ...
   */
  @VisibleForTesting
  static final String KEY_DONOT_SHOW_VIDEO_CHARGES_ALERT = "key_donot_show_video_charges_alert";
   ...
   */
  @Nullable private VideoChargesAlertCallback callback;
   ...
   */
  public void setCallback(@NonNull VideoChargesAlertCallback callback) {
  ...
  public Dialog onCreateDialog(Bundle bundle) {
    ...
    CheckBox alertCheckBox = (CheckBox) dialogView.findViewById(R.id.doNotShow);

    SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(getActivity());
    AlertDialog alertDialog =
        new AlertDialog.Builder(getActivity(), R.style.AlertDialogTheme)
            .setTitle(R.string.videocall_charges_alert_dialog_title)
            .setView(dialogView)
            .setPositiveButton(
                android.R.string.ok,
  ...
  private void onPositiveButtonClicked(@NonNull SharedPreferences preferences, boolean isChecked) {
    LogUtil.i(
        ...
        isChecked);
    if (isChecked) {
      preferences.edit().putBoolean(KEY_DONOT_SHOW_VIDEO_CHARGES_ALERT, isChecked).apply();
    }

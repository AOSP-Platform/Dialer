...
public class VideoCallFragment extends Fragment
      ...
      new Runnable() {
        ...
        public void run() {
          ...
          if (existingVideoChargesAlertFragment != null) {
            LogUtil.i("VideoCallFragment.videoChargesAlertDialogRunnable",
          ...
          if (VideoChargesAlertDialogFragment.shouldShow(getContext(), getCallId())) {
            ...
            VideoChargesAlertDialogFragment.newInstance(getCallId()).show(getChildFragmentManager(),
                TAG_VIDEO_CHARGES_ALERT);
          }
        }
      };
  ...
  public void onVideoScreenStart() {
    ...
    getView().postDelayed(videoChargesAlertDialogRunnable,
        VIDEO_CHARGES_ALERT_DIALOG_DELAY_IN_MILLIS);
  }

...
public class CallButtonPresenter
  ...
  @Nullable private InCallButtonUi inCallButtonUi;
  @Nullable private DialerCall call;
  private boolean isInCallButtonUiReady;
  @Nullable private PhoneAccountHandle otherAccount;
  ...
  private void updateButtonsState(DialerCall call) {
    ...
    final boolean showMerge =
        InCallPresenter.getInstance().getCallList().getAllCalls().stream()
